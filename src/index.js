...
module.exports = {
  ...
  async bootstrap({ strapi }) {
    const io = require("socket.io")(strapi.server.httpServer, {
      cors: {
        origin: ["http://localhost:57503", "https://localhost:57503"], // Update yourdomain.com with your actual domain in production
        methods: ["GET", "POST"],
...
//     const io = require("socket.io")(strapi.server.httpServer, {
//       cors: {
//         origin: ["http://localhost:57503", "https://localhost:57503"],
//         methods: ["GET", "POST"],
//         allowedHeaders: ["my-custom-header"],
//         credentials: true,
//       },
